...
// NAMESPACE OBJECT: ./src/app/api/items/[id]/route.ts
...
;// CONCATENATED MODULE: ./src/app/api/items/[id]/route.ts


const dynamic = "force-dynamic";
const revalidate = 60 // 60秒缓存
;
async function GET(request, { params }) {
    ...
    try {
        const { id } = params;
        const items = await (0,server_utils/* getAllKfcItems */.PP)();
        ...
        return server.NextResponse.json(item, {
            headers
        });
    } catch (error) {
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?page=%2Fapi%2Fitems%2F%5Bid%5D%2Froute&name=app%2Fapi%2Fitems%2F%5Bid%5D%2Froute&pagePath=private-next-app-dir%2Fapi%2Fitems%2F%5Bid%5D%2Froute.ts&appDir=C%3A%5CUsers%5C94362%5CDownloads%5Cvme%5Csrc%5Capp&appPaths=%2Fapi%2Fitems%2F%5Bid%5D%2Froute&pageExtensions=js&pageExtensions=jsx&pageExtensions=ts&pageExtensions=tsx&basePath=&assetPrefix=&nextConfigOutput=&nextConfigExperimentalUseEarlyImport=false&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    ...
    resolvedPagePath: "C:\\Users\\94362\\Downloads\\vme\\src\\app\\api\\items\\[id]\\route.ts",
    nextConfigOutput,
...
const originalPathname = "/api/items/[id]/route";
function patchFetch() {
...
var __webpack_exports__ = __webpack_require__.X(0, [774], () => (__webpack_exec__(52170)));
