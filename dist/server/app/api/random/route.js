...
// NAMESPACE OBJECT: ./src/app/api/random/route.ts
...
;// CONCATENATED MODULE: ./src/app/api/random/route.ts
...
async function GET(request) {
    ...
    try {
        ...
        const randomItem = await (0,server_utils/* getRandomKfcItem */.k1)();
        if (!randomItem) {
        ...
        if (format === "text") {
            return new server.NextResponse(randomItem.body || "暂无数据", {
                headers
            });
        } else {
            ...
            return server.NextResponse.json(basicItem, {
                headers
            });
        }
    } catch (error) {
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?page=%2Fapi%2Frandom%2Froute&name=app%2Fapi%2Frandom%2Froute&pagePath=private-next-app-dir%2Fapi%2Frandom%2Froute.ts&appDir=C%3A%5CUsers%5C94362%5CDownloads%5Cvme%5Csrc%5Capp&appPaths=%2Fapi%2Frandom%2Froute&pageExtensions=js&pageExtensions=jsx&pageExtensions=ts&pageExtensions=tsx&basePath=&assetPrefix=&nextConfigOutput=&nextConfigExperimentalUseEarlyImport=false&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new module_compiled.AppRouteRouteModule({
    definition: {
        ...
        pathname: "/api/random",
        filename: "route",
        bundlePath: "app/api/random/route"
    },
    resolvedPagePath: "C:\\Users\\94362\\Downloads\\vme\\src\\app\\api\\random\\route.ts",
    nextConfigOutput,
...
const originalPathname = "/api/random/route";
function patchFetch() {
...
var __webpack_exports__ = __webpack_require__.X(0, [774], () => (__webpack_exec__(22700)));
